...
namespace VAA.DataAccess
{
    ...
    public class BaseItemManagement : IBaseItem
    {
        ...
        public List<BaseItem> GetBaseItems(int classId, int menuTypeId, int languageId)
        {
            try
            {
                ...
                return (from data in baseItemData
                        join menucat in _context.tMenuItemCategory on data.CategoryID equals menucat.ID
                        select new BaseItem
                        {
                            ...
                            CategoryCode = menucat.CategoryCode,
        ...
        public bool UpdateBaseItem(BaseItem baseItem)
        {
            try
            {
                var baseItemUpdate = (from tBaseItems in _context.tBaseItems where tBaseItems.BaseItemCode == baseItem.BaseItemCode select tBaseItems).FirstOrDefault();
