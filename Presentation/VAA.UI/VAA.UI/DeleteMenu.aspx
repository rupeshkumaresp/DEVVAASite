<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DeleteMenu.aspx.cs" Inherits="VAA.UI.DeleteMenu" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="updpnlValidateDeleteMenu" runat="server">
        <ContentTemplate>
            <script src="Scripts/bootbox.js"></script>
            <script type="text/javascript">
                function DeleteCompleted() {
                    bootbox.alert("Menu Deletion is complete!");
                }


            </script>
            <h3 style="text-decoration: underline">Menu Action - Delete Menu(s)</h3>
            <br />
            <div>
                <table style="width: 650px;">
                    <tr>
                        ...
                        <td style="text-align: left">
                            ...
                            <div>
                                (Please enter comma separated Menu codes for more than one menu)
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="padding-top: 40px; padding-bottom: 30px; padding-right: 150px;">
                            <asp:Button ID="btnDeleteMenu" runat="server" Text="Delete Menu" Class="button" OnClick="btnDeleteMenu_Click" />
                        </td>
                    </tr>
                </table>
            </div>
    ...
    <asp:UpdateProgress ID="updProgress" AssociatedUpdatePanelID="updpnlValidateDeleteMenu" runat="server" DisplayAfter="0">
        <ProgressTemplate>
