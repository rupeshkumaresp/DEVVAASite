...
namespace VAA.CommonComponents
{
    ...
    public class EmailHelper
    {
       ...
       @"<p>
        ...
        public static string FlightScheduleMailTemplate =

       @"<p>
    	Hi,</p>
        <p>
	        This is to inform that Flight Schedule present in database doesn't cover entire date range i.e. date start and date end for the current live order.
        <p>
	        Please request a new flight schedule from Virgin and upload this new flight schedule. Once upload is complete, please calculate the live order menu quantity.
        <p>
       ...
       @"<p>
        ...
        public static string MissingEquipmentEmailTemplate =

      @"<p>
    	Hi,</p>
        <p>
	        The schedule contains below equipments which are not present in database:</p>
        <p>
	        [EQUIPMENTS]</p>
        <p>
      
        <p>
	        Please add these equipment in database. After this please upload schedule again! </p>
        <p>
	        &nbsp;</p>
        <p>
	        Kind Regards,</p>
     ...
     @"<p>
        ...
        public static string BaseMenuItemsUploadTemplate =
             @"<p>
    	Hi,</p>
        <p>
	        This is to notify you that Base Menu Items upload has been completed successfully.</p>
    ...
    @"<p>
        ...
        public static void SendMail(string eto, string efrom, string subject, string message)
        {
            try
            {
                ...
                var smtp = new SmtpClient("espcolour-co-uk.mail.protection.outlook.com");
